...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dynamicStore = __webpack_require__(3);

	var _dynamicStore2 = _interopRequireDefault(_dynamicStore);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	/* exports cb */
	window.cb = {
	  store: new _dynamicStore2.default(_redux.createStore, _redux.combineReducers)
	};
...
/***/ function(module, exports) {
	...
	var DynamicStore = function () {
	  function DynamicStore(createStore, combineReducers) {
	    _classCallCheck(this, DynamicStore);

	    this._store = createStore(function (state) {
	      return state;
	    });
	  ...
	  _createClass(DynamicStore, [{
	    ...
	    value: function registerReducer(name, reducer) {
	      ...
	      this._reducers = Object.assign({}, this._reducers, _defineProperty({}, name, reducer));
	    ...
	    key: 'subscribeTo',
	    value: function subscribeTo(namespace, handler) {
	      var _this = this;

	      var store = this._store;
	      var selector = function selector(state) {
	        return _this._getPropertyByNamespace(namespace, state);
	      };
	    ...
	    key: '_getPropertyByNamespace',
	    value: function _getPropertyByNamespace(namespace, object) {
